...
let tests () =
  ...
  @ (data_integrity_tests export_import_raw
       "VDI export/import to/from raw\n  file" "vhd"
    |> supported_srs
    )
  @ (data_integrity_tests export_import_vhd
       "VDI export/import to/from VHD\n  file" "vhd"
    |> supported_srs
    )

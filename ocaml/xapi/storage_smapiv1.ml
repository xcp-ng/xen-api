...
module SMAPIv1 : Server_impl = struct
  ...
  module DATA = struct
    ...
    module MIRROR = struct
      ...
      let receive_start _context ~dbg:_ ~sr:_ ~vdi_info:_ ~image_format:_ ~id:_
          ~similar:_ =
        assert false

      let receive_start2 _context ~dbg:_ ~sr:_ ~vdi_info:_ ~image_format:_ ~id:_
          ~similar:_ ~vm:_ =
        assert false

      let receive_start3 _context ~dbg:_ ~sr:_ ~vdi_info:_ ~image_format:_
          ~mirror_id:_ ~similar:_ ~vm:_ ~url:_ ~verify_dest:_ =
        assert false
